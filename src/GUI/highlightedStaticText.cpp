...
GUI::HighlightedStaticText::HighlightedStaticText(const Window& _target, const LanguagedText _texts,
    float _X, float _Y, int frame, float _height, Color _color, Aligment _aligment) {
