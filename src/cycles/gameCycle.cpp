...
currentTurnText(_window, 0.5, 0.05, {"First player turn", "Ход первого игрока", "Der Zug des ersten Spielers", "Ход першага гульца"}),
opponentTurnText(_window, 0.5, 0.05, {"Second player turn", "Ход второго игрока", "Zug des zweiten Spielers", "Ход другога гульца"}),
firstWinText(_window, 0.5, 0.05, {"First win", "Первый победил", "Der erste hat gewonnen", "Першы перамог"}),
secondWinText(_window, 0.5, 0.05, {"Second win", "Второй победил", "Der zweite hat gewonnen", "Другі перамог"}),
